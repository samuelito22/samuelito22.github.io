...
function popularity(){
    url = 'https://kitsu.io/api/edge/manga?sort=popularityRank&page[limit]=18&page[offset]=';
    offset = 0;
    setUp('comic_set');
}
function ranking(){
    url = 'https://kitsu.io/api/edge/manga?sort=ratingRank&page[limit]=18&page[offset]=';
    offset = 0;
    setUp('comic_set');
}

function sortNew(){
    url = 'https://kitsu.io/api/edge/manga?sort=-startDate&page[limit]=18&page[offset]=';
    offset = 0;
    setUp('comic_set');
}

function mangaType(name){
    url = 'https://kitsu.io/api/edge/manga?filter[mangaType]='+name+'&sort=popularityRank&page[limit]=18&page[offset]=';
    offset = 0;
    setUp('comic_set');
}

function status_(name){
    url = 'https://kitsu.io/api/edge/manga?filter[status]='+name+'&sort=popularityRank&page[limit]=18&page[offset]=';
    offset = 0;
    setUp('comic_set');
}
